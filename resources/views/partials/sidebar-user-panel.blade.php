@if($user)
    ...
    <div class="sticky-bottom bottom-0 start-0 navbar-light">
        <hr class="bg-gray-200 border-gray-200 opacity-100">
        <li class="nav-item">
            <a class="nav-link" href="{{ admin_url('auth/setting') }}">
                <svg data-name="Icons/Tabler/Share" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                     viewBox="0 0 16 16">
                    <rect id="Icons_Tabler_User_background" data-name="Icons/Tabler/User background" width="16"
                          height="16" fill="none"/>
                ...
                <span class="ms-2">{{ trans('admin.setting') }}</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ admin_url('auth/logout') }}">
                ...
                <span class="ms-2">{{ trans('admin.logout') }}</span></a>
        </li>
    </div>
@endif
